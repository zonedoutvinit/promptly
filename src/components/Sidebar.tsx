    ...
    <>
      ...
      >
        ...
        */}
        <div className="flex flex-col h-full w-64 overflow-hidden">
          ...
          <div className="p-4 border-b border-zinc-900 flex items-center justify-between">
            ...
            <button
              ...
              className="text-zinc-500 hover:text-zinc-300 p-1 hover:bg-zinc-900 rounded transition cursor-pointer text-xs"
            >
              ✕
            </button>
          </div>
          ...
          <div className="p-3">
            <button
              onClick={onNewChat}
              className="w-full bg-zinc-900 hover:bg-zinc-800 text-zinc-200 border border-zinc-800 px-4 py-2.5 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition cursor-pointer"
            >
              <span>+</span> New Chat
            </button>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 p-1 hover:bg-zinc-800 text-zinc-600 hover:text-rose-400 rounded transition cursor-pointer"
                  >
                    🗑️
                  </button>
                </div>
        ...
        {/* Bottom Dock Container featuring Sandbox metadata and Settings Gear trigger */}
        <div className="p-4 border-t border-zinc-900 text-[10px] text-zinc-600 font-mono w-64 flex items-center justify-between">
          <div>
            Sandbox:{" "}
            <span className="text-emerald-600">Local Threads Indexed</span>
          </div>
          <button
            onClick={() => setIsSettingsOpen(true)}
            className="text-zinc-500 hover:text-zinc-300 p-1 hover:bg-zinc-900 rounded transition cursor-pointer flex items-center justify-center text-sm"
      ...
      {/* Global Sandbox Engine Overlays */}
      <SettingsModal
